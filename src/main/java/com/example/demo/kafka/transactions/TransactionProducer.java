package com.example.demo.kafka.transactions;
...
public class TransactionProducer {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // 发送消息到producer-syn
            producer.send(new ProducerRecord<>("producer-syn", "test3"));
            // 发送消息到producer-asyn
            Future<RecordMetadata> metadataFuture = producer.send(new ProducerRecord<>("producer-asyn", "test4"));
            // 提交事务
